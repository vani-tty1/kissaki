...
BINS := meson ninja appstreamcli desktop-file-validate glib-compile-schemas blueprint-compiler pkg-config xgettext gtk4-update-icon-cache update-desktop-database
